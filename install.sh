...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY SHINN CODE            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "shinn" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Shinn${NC}"
    echo -e "${YELLOW}TELEGRAM : @ShinnHost${NC}"
    echo -e "${YELLOW}WHATSAPP : 6282336762967${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 20K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©Shinn${NC}"
    exit 1
  fi
  clear
}
  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        ...
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/ShinnHost/pterodactyl/raw/main/C1.zip")
        break
        ;;
      3)
...
while true; do
  ...
  echo -e "${WHITE}'ggg      ,gg'''  .    ggg       Auto Installer Shinn   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${WHITE}ggg:     gg.     -   ,ggg       • Telegram : @ShinnHost   ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : Shinn           ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by Shinn              ${NC}"
  echo -e "${WHITE}  'ggg    '-.__                 • WhatsApp : 6282336762967                                     ${NC}"                         
  echo -e "${RED}    ggg                                                   ${NC}"
  echo -e "${RED}      ggg                                                 ${NC}"
  echo -e "${RED}        ggg.                                              ${NC}"
  echo -e "${RED}          ggg.                                            ${NC}"
